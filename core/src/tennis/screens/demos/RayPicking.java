...
public class RayPicking extends InputAdapter implements Screen {
    ...
    public void show() {
        ...
        assets.load("demos/scene/invaderscene.g3db", Model.class);
        loading = true;
    ...
    private void doneLoading () {
        Model model = assets.get("demos/scene/invaderscene.g3db", Model.class);
